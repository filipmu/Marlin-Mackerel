...
// Please note these are limited to 17 characters!
	...
	#define MSG_BED "Bed"
	#define MSG_WINDER_SPEED "Winder speed"
...
// Please note these are limited to 17 characters!
	...
	#define MSG_MAIN             "HauptmenÃƒÂ¼"
	#define MSG_AUTOSTART        "Autostart"
	#define MSG_DISABLE_STEPPERS "Stepper abschalt."
	#define MSG_AUTO_HOME        "Auto Nullpunkt"
	#define MSG_SET_ORIGIN       "Setze Nullpunkt"
	#define MSG_PREHEAT_PLA      "VorwÃƒÂ¤rmen PLA"
	#define MSG_PREHEAT_PLA0     "VorwÃƒÂ¤rmen PLA 1"
	#define MSG_PREHEAT_PLA1     "VorwÃƒÂ¤rmen PLA 2"
	#define MSG_PREHEAT_PLA2     "VorwÃƒÂ¤rmen PLA 3"
	#define MSG_PREHEAT_PLA012   "Vorw. PLA Alle"
	#define MSG_PREHEAT_PLA_BEDONLY "Vorw. PLA Bett"
	#define MSG_PREHEAT_PLA_SETTINGS "VorwÃƒÂ¤rm. PLA Ein."
	#define MSG_PREHEAT_ABS      "VorwÃƒÂ¤rmen ABS"
	#define MSG_PREHEAT_ABS0     "VorwÃƒÂ¤rmen ABS 1"
	#define MSG_PREHEAT_ABS1     "VorwÃƒÂ¤rmen ABS 2"
	#define MSG_PREHEAT_ABS2     "VorwÃƒÂ¤rmen ABS 3"
	#define MSG_PREHEAT_ABS012   "Vorw. ABS Alle"
	#define MSG_PREHEAT_ABS_BEDONLY "Vorw. ABS Bett"
	#define MSG_PREHEAT_ABS_SETTINGS "VorwÃƒÂ¤rm. ABS Ein."
	#define MSG_COOLDOWN         "AbkÃƒÂ¼hlen"
	#define MSG_SWITCH_PS_ON     "Switch Power On"
	#define MSG_SWITCH_PS_OFF    "Switch Power Off"
	#define MSG_EXTRUDE          "Extrude"
	#define MSG_RETRACT          "Retract"
	...
	#define MSG_NOZZLE           "DÃƒÂ¼se"
	#define MSG_NOZZLE1          "DÃƒÂ¼se2"
	#define MSG_NOZZLE2          "DÃƒÂ¼se3"
	#define MSG_BED              "Bett"
	#define MSG_FAN_SPEED        "LÃƒÂ¼ftergeschw."
	...
	#define MSG_CARD_MENU        "SDKarten MenÃƒÂ¼"
...
// Serial Console Messages
	...
	#define MSG_ERR_KILLED "Ã‚Â¡Ã‚Â¡Impresora Parada con kill()!!"
	#define MSG_ERR_STOPPED "Ã‚Â¡Impresora parada por errores. Arregle el error y use M999 Para reiniciar!. (La temperatura se reestablece. Ajustela antes de continuar)"
...
// Please note these are limited to 17 characters!
	...
	#define WELCOME_MSG MACHINE_NAME			        "Ã�â€œÃ�Â¾Ã‘â€šÃ�Â¾Ã�Â²."
	#define MSG_SD_INSERTED						"Ã�Å¡Ã�Â°Ã‘â‚¬Ã‘â€šÃ�Â° Ã�Â²Ã‘ï¿½Ã‘â€šÃ�Â°Ã�Â²Ã�Â»Ã�ÂµÃ�Â½Ã�Â°"
	#define MSG_SD_REMOVED						"Ã�Å¡Ã�Â°Ã‘â‚¬Ã‘â€šÃ�Â° Ã�Â¸Ã�Â·Ã�Â²Ã�Â»Ã�ÂµÃ‘â€¡Ã�ÂµÃ�Â½Ã�Â°"
	#define MSG_MAIN							"Ã�Å“Ã�ÂµÃ�Â½Ã‘Å½ \003"
	#define MSG_AUTOSTART						"Ã�ï¿½Ã�Â²Ã‘â€šÃ�Â¾Ã‘ï¿½Ã‘â€šÃ�Â°Ã‘â‚¬Ã‘â€š"
	#define MSG_DISABLE_STEPPERS 				"Ã�â€™Ã‘â€¹Ã�ÂºÃ�Â». Ã�Â´Ã�Â²Ã�Â¸Ã�Â³Ã�Â°Ã‘â€šÃ�ÂµÃ�Â»Ã�Â¸"
	#define MSG_AUTO_HOME						"Ã�Å¸Ã�Â°Ã‘â‚¬Ã�ÂºÃ�Â¾Ã�Â²Ã�ÂºÃ�Â°"
	#define MSG_SET_ORIGIN						"Ã�â€”Ã�Â°Ã�Â¿Ã�Â¾Ã�Â¼Ã�Â½Ã�Â¸Ã‘â€šÃ‘Å’ Ã�Â½Ã�Â¾Ã�Â»Ã‘Å’"
	#define MSG_PREHEAT_PLA 					"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â² PLA"
	#define MSG_PREHEAT_PLA0					"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â² PLA0"
	#define MSG_PREHEAT_PLA1					"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â² PLA1"
	#define MSG_PREHEAT_PLA2					"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â² PLA2"
	#define MSG_PREHEAT_PLA012 					"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³. PLA Ã�Â²Ã‘ï¿½Ã�Âµ"
	#define MSG_PREHEAT_PLA_BEDONLY 			"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´. PLA Ã�Å¡Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã‘â€šÃ‘Å’"
	#define MSG_PREHEAT_PLA_SETTINGS  			"Ã�ï¿½Ã�Â°Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â¹Ã�ÂºÃ�Â¸ PLA"
	#define MSG_PREHEAT_ABS						"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â² ABS"
	#define MSG_PREHEAT_ABS0					"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â² ABS0"
	#define MSG_PREHEAT_ABS1					"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â² ABS1"
	#define MSG_PREHEAT_ABS2					"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â² ABS2"
	#define MSG_PREHEAT_ABS012 					"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�Â°Ã�Â³. ABS Ã�Â²Ã‘ï¿½Ã�Âµ "
	#define MSG_PREHEAT_ABS_BEDONLY 			"Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´. ABS Ã�Å¡Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã‘â€šÃ‘Å’"
	#define MSG_PREHEAT_ABS_SETTINGS  			"Ã�ï¿½Ã�Â°Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â¹Ã�ÂºÃ�Â¸ ABS"
	#define MSG_COOLDOWN						"Ã�Å¾Ã‘â€¦Ã�Â»Ã�Â°Ã�Â¶Ã�Â´Ã�ÂµÃ�Â½Ã�Â¸Ã�Âµ"
	#define MSG_SWITCH_PS_ON					"Switch Power On"
	#define MSG_SWITCH_PS_OFF					"Switch Power Off"
	#define MSG_EXTRUDE							"Ã�Â­Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â·Ã�Â¸Ã‘ï¿½"
	#define MSG_RETRACT							"Ã�Å¾Ã‘â€šÃ�ÂºÃ�Â°Ã‘â€š"
	#define MSG_MOVE_AXIS  						"Ã�â€�Ã�Â²Ã�Â¸Ã�Â¶Ã�ÂµÃ�Â½Ã�Â¸Ã�Âµ Ã�Â¿Ã�Â¾ Ã�Â¾Ã‘ï¿½Ã‘ï¿½Ã�Â¼"
	#define MSG_MOVE_X                          "Move X"
	#define MSG_MOVE_Y                          "Move Y"
	#define MSG_MOVE_Z                          "Move Z"
	#define MSG_MOVE_E                          "Extruder"
	...
	#define MSG_MOVE_1MM                        "Move 1mm"
	#define MSG_MOVE_10MM                       "Move 10mm"
	#define MSG_SPEED							"Ã�Â¡Ã�ÂºÃ�Â¾Ã‘â‚¬Ã�Â¾Ã‘ï¿½Ã‘â€šÃ‘Å’:"
	#define MSG_NOZZLE							"\002 Ã�Â¤Ã�Â¸Ã�Â»Ã‘Å’Ã�ÂµÃ‘â‚¬Ã�Â°:"
	#define MSG_NOZZLE1							"\002 Ã�Â¤Ã�Â¸Ã�Â»Ã‘Å’Ã�ÂµÃ‘â‚¬Ã�Â°2:"
	#define MSG_NOZZLE2							"\002 Ã�Â¤Ã�Â¸Ã�Â»Ã‘Å’Ã�ÂµÃ‘â‚¬Ã�Â°3:"
	#define MSG_BED								"\002 Ã�Å¡Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã‘â€šÃ‘Å’:"
	#define MSG_FAN_SPEED						"Ã�Å¡Ã‘Æ’Ã�Â»Ã�Â»Ã�ÂµÃ‘â‚¬:"
	#define MSG_FLOW							"Ã�Å¸Ã�Â¾Ã‘â€šÃ�Â¾Ã�Âº:"
	#define MSG_FLOW0 " Ã�Å¸Ã�Â¾Ã‘â€šÃ�Â¾Ã�Âº0:"
	#define MSG_FLOW1 " Ã�Å¸Ã�Â¾Ã‘â€šÃ�Â¾Ã�Âº1:"
	#define MSG_FLOW2 " Ã�Å¸Ã�Â¾Ã‘â€šÃ�Â¾Ã�Âº2:"
	#define MSG_CONTROL							"Ã�ï¿½Ã�Â°Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â¹Ã�ÂºÃ�Â¸ \003"
	#define MSG_MIN								"\002 Ã�Å“Ã�Â¸Ã�Â½Ã�Â¸Ã�Â¼Ã‘Æ’Ã�Â¼:"
	#define MSG_MAX								"\002 Ã�Å“Ã�Â°Ã�ÂºÃ‘ï¿½Ã�Â¸Ã�Â¼Ã‘Æ’Ã�Â¼:"
	#define MSG_FACTOR							"\002 Ã�Â¤Ã�Â°Ã�ÂºÃ‘â€šÃ�Â¾Ã‘â‚¬:"
	#define MSG_AUTOTEMP						"Autotemp:"
	#define MSG_ON								"Ã�â€™Ã�ÂºÃ�Â». "
	#define MSG_OFF								"Ã�â€™Ã‘â€¹Ã�ÂºÃ�Â». "
	#define MSG_PID_P							"PID-P: "
	#define MSG_PID_I							"PID-I: "
	#define MSG_PID_D							"PID-D: "
	#define MSG_PID_C							"PID-C: "
	...
	#define MSG_AMAX							"Amax "
	#define MSG_A_RETRACT						"A-retract:"
	#define MSG_XSTEPS							"X Ã‘Ë†Ã�Â°Ã�Â³/mm:"
	#define MSG_YSTEPS							"Y Ã‘Ë†Ã�Â°Ã�Â³/mm:"
	#define MSG_ZSTEPS							"Z Ã‘Ë†Ã�Â°Ã�Â³/mm:"
	#define MSG_ESTEPS							"E Ã‘Ë†Ã�Â°Ã�Â³/mm:"
	#define MSG_RECTRACT    					"Ã�Å¾Ã‘â€šÃ�ÂºÃ�Â°Ã‘â€š Ã�Â¿Ã�Â¾Ã�Â´Ã�Â°Ã‘â€¡Ã�Â¸    \x7E"
	#define MSG_TEMPERATURE  					"Ã�Â¢Ã�ÂµÃ�Â¼Ã�Â¿Ã�ÂµÃ‘â‚¬Ã�Â°Ã‘â€šÃ‘Æ’Ã‘â‚¬Ã�Â°     \x7E"
	#define MSG_MOTION							"Ã�Â¡Ã�ÂºÃ�Â¾Ã‘â‚¬Ã�Â¾Ã‘ï¿½Ã‘â€šÃ�Â¸        \x7E"
	#define MSG_CONTRAST  						"LCD contrast"
	#define MSG_STORE_EPROM  					"Ã�Â¡Ã�Â¾Ã‘â€¦Ã‘â‚¬Ã�Â°Ã�Â½Ã�Â¸Ã‘â€šÃ‘Å’ Ã�Â² EPROM"
	#define MSG_LOAD_EPROM  					"Ã�â€”Ã�Â°Ã�Â³Ã‘â‚¬Ã‘Æ’Ã�Â·. Ã�Â¸Ã�Â· EPROM"
	#define MSG_RESTORE_FAILSAFE				"Ã�Â¡Ã�Â±Ã‘â‚¬Ã�Â¾Ã‘ï¿½ Ã�Â½Ã�Â°Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�ÂµÃ�Âº"
	#define MSG_REFRESH							"\004Ã�Å¾Ã�Â±Ã�Â½Ã�Â¾Ã�Â²Ã�Â¸Ã‘â€šÃ‘Å’"
	#define MSG_WATCH							"Ã�Å¾Ã�Â±Ã�Â·Ã�Â¾Ã‘â‚¬           \003"
	#define MSG_PREPARE							"Ã�â€�Ã�ÂµÃ�Â¹Ã‘ï¿½Ã‘â€šÃ�Â²Ã�Â¸Ã‘ï¿½        \x7E"
	#define MSG_TUNE							"Ã�ï¿½Ã�Â°Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â¹Ã�ÂºÃ�Â¸       \x7E"
	#define MSG_PAUSE_PRINT  					"Ã�Å¸Ã‘â‚¬Ã�Â¾Ã�Â´Ã�Â¾Ã�Â»Ã�Â¶Ã�Â¸Ã‘â€šÃ‘Å’ Ã�Â¿Ã�ÂµÃ‘â€¡Ã�Â°Ã‘â€šÃ‘Å’"
	#define MSG_RESUME_PRINT					"Ã�Â²Ã�Â¾Ã�Â·Ã�Â¾Ã�Â±Ã�Â½. Ã�Â¿Ã�ÂµÃ‘â€¡Ã�Â°Ã‘â€šÃ‘Å’"
	#define MSG_STOP_PRINT 						"Ã�Å¾Ã‘ï¿½Ã‘â€šÃ�Â°Ã�Â½Ã�Â¾Ã�Â²Ã�Â¸Ã‘â€šÃ‘Å’ Ã�Â¿Ã�ÂµÃ‘â€¡Ã�Â°Ã‘â€šÃ‘Å’"
	#define MSG_CARD_MENU						"Ã�Å“Ã�ÂµÃ�Â½Ã‘Å½ Ã�ÂºÃ�Â°Ã‘â‚¬Ã‘â€šÃ‘â€¹      \x7E"
	#define MSG_NO_CARD							"Ã�ï¿½Ã�ÂµÃ‘â€š Ã�ÂºÃ�Â°Ã‘â‚¬Ã‘â€šÃ‘â€¹"
	#define MSG_DWELL							"Ã�Â¡Ã�Â¾Ã�Â½..."
	#define MSG_USERWAIT  						"Ã�Å¾Ã�Â¶Ã�Â¸Ã�Â´Ã�Â°Ã�Â½Ã�Â¸Ã�Â¸Ã�Âµ"
	#define MSG_RESUMING 						"Resuming print"
	#define MSG_NO_MOVE							"Ã�ï¿½Ã�ÂµÃ‘â€š Ã�Â´Ã�Â²Ã�Â¸Ã�Â¶Ã�ÂµÃ�Â½Ã�Â¸Ã‘ï¿½."
	#define MSG_KILLED							"Ã�Â£Ã�â€˜Ã�ËœÃ�Â¢Ã�Å¾."
	#define MSG_STOPPED							"Ã�Å¾Ã�Â¡Ã�Â¢Ã�ï¿½Ã�ï¿½Ã�Å¾Ã�â€™Ã�â€ºÃ�â€¢Ã�ï¿½Ã�Å¾."
	#define MSG_CONTROL_RETRACT					"Ã�Å¾Ã‘â€šÃ�ÂºÃ�Â°Ã‘â€š mm:"
	#define MSG_CONTROL_RETRACTF				"Ã�Å¾Ã‘â€šÃ�ÂºÃ�Â°Ã‘â€š  F:"
	#define MSG_CONTROL_RETRACT_ZLIFT			"Ã�Å¸Ã‘â‚¬Ã‘â€¹Ã�Â¶Ã�Â¾Ã�Âº mm:"
	#define MSG_CONTROL_RETRACT_RECOVER			"Ã�â€™Ã�Â¾Ã�Â·Ã�Â²Ã‘â‚¬Ã�Â°Ã‘â€š +mm:"
	#define MSG_CONTROL_RETRACT_RECOVERF		"Ã�â€™Ã�Â¾Ã�Â·Ã�Â²Ã‘â‚¬Ã�Â°Ã‘â€š  F:"
	#define MSG_AUTORETRACT						"Ã�ï¿½Ã�Â²Ã‘â€šÃ�Â¾Ã�Å¾Ã‘â€šÃ�ÂºÃ�Â°Ã‘â€š:"
	#define MSG_FILAMENTCHANGE 					"Change filament"
	#define MSG_INIT_SDCARD 					"Init. SD-Card"
	#define MSG_CNG_SDCARD 						"Change SD-Card"
	#define MSG_ZPROBE_OUT 						"Z probe out. bed"
...
// Serial Console Messages
	...
	#define MSG_Enqueing						"Ã�â€”Ã�Â°Ã�Â¿Ã�Â»Ã�Â°Ã�Â½Ã�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã�Â½Ã�Â¾ \""
	#define MSG_POWERUP							"Ã�â€™Ã�ÂºÃ�Â»Ã‘Å½Ã‘â€¡Ã�ÂµÃ�Â½Ã�Â¸Ã�Âµ Ã�Â¿Ã�Â¸Ã‘â€šÃ�Â°Ã�Â½Ã�Â¸Ã‘ï¿½"
	#define MSG_EXTERNAL_RESET					" Ã�â€™Ã�Â½Ã�ÂµÃ‘Ë†Ã�Â½Ã�Â¸Ã�Â¹ Ã‘ï¿½Ã�Â±Ã‘â‚¬Ã�Â¾Ã‘ï¿½"
	#define MSG_BROWNOUT_RESET					" Brown out Ã‘ï¿½Ã�Â±Ã‘â‚¬Ã�Â¾Ã‘ï¿½"
	#define MSG_WATCHDOG_RESET					" Watchdog Ã‘ï¿½Ã�Â±Ã‘â‚¬Ã�Â¾Ã‘ï¿½"
	#define MSG_SOFTWARE_RESET					" Ã�Â¿Ã‘â‚¬Ã�Â¾Ã�Â³Ã‘â‚¬Ã�Â°Ã�Â¼Ã�Â¼Ã�Â½Ã‘â€¹Ã�Â¹ Ã‘ï¿½Ã�Â±Ã‘â‚¬Ã�Â¾Ã‘ï¿½"
	#define MSG_AUTHOR							" | Ã�ï¿½Ã�Â²Ã‘â€šÃ�Â¾Ã‘â‚¬: "
	#define MSG_CONFIGURATION_VER				" Ã�Å¸Ã�Â¾Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â´Ã�Â½Ã�ÂµÃ�Âµ Ã�Â¾Ã�Â±Ã�Â½Ã�Â¾Ã�Â²Ã�Â»Ã�ÂµÃ�Â½Ã�Â¸Ã�Âµ: "
	#define MSG_FREE_MEMORY						" Ã�Å¸Ã�Â°Ã�Â¼Ã‘ï¿½Ã‘â€šÃ�Â¸ Ã‘ï¿½Ã�Â²Ã�Â¾Ã�Â±Ã�Â¾Ã�Â´Ã�Â½Ã�Â¾: "
	#define MSG_PLANNER_BUFFER_BYTES			"  Ã�â€˜Ã‘Æ’Ã‘â€žÃ‘â€žÃ�ÂµÃ‘â‚¬ Ã�Â¾Ã‘â€¡Ã�ÂµÃ‘â‚¬Ã�ÂµÃ�Â´Ã�Â¸ Ã�ÂºÃ�Â¾Ã�Â¼Ã�Â°Ã�Â½Ã�Â´ Bytes: "
	#define MSG_OK								"ok"
	#define MSG_FILE_SAVED						"Ã�Â¤Ã�Â°Ã�Â¹Ã�Â» Ã�Â·Ã�Â°Ã�Â¿Ã�Â¸Ã‘ï¿½Ã�Â°Ã�Â½."
	#define MSG_ERR_LINE_NO						"Ã�ï¿½Ã�Â¾Ã�Â¼Ã�ÂµÃ�Â½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�ÂºÃ�Â¸ Ã‘ï¿½Ã‘â€šÃ�Â¾ Ã�Â½Ã�Âµ Ã�Â¿Ã�Â¾Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â´Ã�Â½Ã‘ï¿½Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�ÂºÃ�Â°+1, Ã�Â¿Ã�Â¾Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â´Ã�Â½Ã‘ï¿½Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�ÂºÃ�Â°:"
	#define MSG_ERR_CHECKSUM_MISMATCH			"Ã�ÂºÃ�Â¾Ã�Â½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â»Ã‘Å’Ã�Â½Ã�Â°Ã‘ï¿½ Ã‘ï¿½Ã‘Æ’Ã�Â¼Ã�Â¼Ã�Â° Ã�Â½Ã�Âµ Ã‘ï¿½Ã�Â¾Ã�Â²Ã�Â¿Ã�Â°Ã�Â´Ã�Â°Ã�ÂµÃ‘â€š, Ã�Â¿Ã�Â¾Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â´Ã�Â½Ã‘ï¿½Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�ÂºÃ�Â°:"
	#define MSG_ERR_NO_CHECKSUM					"Ã�Â½Ã�ÂµÃ‘â€š Ã�ÂºÃ�Â¾Ã�Â½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â»Ã‘Å’Ã�Â½Ã�Â¾Ã�Â¹ Ã‘ï¿½Ã‘Æ’Ã�Â¼Ã�Â¼Ã‘â€¹ Ã�Â´Ã�Â»Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�ÂºÃ�Â¸, Ã�Â¿Ã�Â¾Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â´Ã�Â½Ã‘ï¿½Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�ÂºÃ�Â°:"
	#define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM	"Ã�Â½Ã�ÂµÃ‘â€š Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�ÂºÃ�Â¸ Ã�Â´Ã�Â»Ã‘ï¿½ Ã�ÂºÃ�Â¾Ã�Â½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â»Ã‘Å’Ã�Â½Ã�Â¾Ã�Â¹ Ã‘ï¿½Ã‘Æ’Ã�Â¼Ã�Â¼Ã‘â€¹, Ã�Â¿Ã�Â¾Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â´Ã�Â½Ã‘ï¿½Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�ÂºÃ�Â°:"
	#define MSG_FILE_PRINTED					"Ã�Å¸Ã�ÂµÃ‘â€¡Ã�Â°Ã‘â€šÃ‘Å’ Ã‘â€žÃ�Â°Ã�Â¹Ã�Â»Ã�Â° Ã�Â·Ã�Â°Ã�Â²Ã�ÂµÃ‘â‚¬Ã‘Ë†Ã�ÂµÃ�Â½Ã�Â°"
	#define MSG_BEGIN_FILE_LIST					"Ã�Â¡Ã�Â¿Ã�Â¸Ã‘ï¿½Ã�Â¾Ã�Âº Ã‘â€žÃ�Â°Ã�Â¹Ã�Â»Ã�Â¾Ã�Â²"
	#define MSG_END_FILE_LIST					"Ã�Å¡Ã�Â¾Ã�Â½Ã�ÂµÃ‘â€  Ã‘ï¿½Ã�Â¿Ã�Â¸Ã‘ï¿½Ã�ÂºÃ�Â° Ã‘â€žÃ�Â°Ã�Â¹Ã�Â»Ã�Â¾Ã�Â²"
	#define MSG_M104_INVALID_EXTRUDER			"M104 Ã�Â¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â° "
	#define MSG_M105_INVALID_EXTRUDER			"M105 Ã�Â¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â° "
	#define MSG_M200_INVALID_EXTRUDER			"M200 Ã�Â¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â° "
	#define MSG_M218_INVALID_EXTRUDER			"M218 Ã�Â¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â° "
	#define MSG_M221_INVALID_EXTRUDER			"M221 Ã�Â¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â° "
	#define MSG_ERR_NO_THERMISTORS				"Ã�ï¿½Ã�ÂµÃ‘â€š Ã‘â€šÃ�ÂµÃ‘â‚¬Ã�Â¼Ã�Â¸Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â° - Ã�Â½Ã�ÂµÃ‘â€š Ã‘â€šÃ�ÂµÃ�Â¼Ã�Â¿Ã�ÂµÃ‘â‚¬Ã�Â°Ã‘â€šÃ‘Æ’Ã‘â‚¬Ã‘â€¹"
	#define MSG_M109_INVALID_EXTRUDER			"M109 Ã�Â¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â° "
	#define MSG_HEATING							"Ã�ï¿½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â²...  "
	#define MSG_HEATING_COMPLETE				"Ã�ï¿½Ã�Â°Ã‘â‚¬Ã�Â³Ã�ÂµÃ‘â€šÃ�Â¾.    "
	#define MSG_BED_HEATING						"Ã�ï¿½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ�Â² Ã‘ï¿½Ã‘â€šÃ�Â¾Ã�Â»Ã�Â°...     "
	#define MSG_BED_DONE						"Ã�Â¡Ã‘â€šÃ�Â¾Ã�Â» Ã�Â½Ã�Â°Ã�Â³Ã‘â‚¬Ã�ÂµÃ‘â€š.        "
	#define MSG_M115_REPORT						"FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
	#define MSG_COUNT_X							" Count X:"
	#define MSG_ERR_KILLED						"Ã�Å¸Ã‘â‚¬Ã�Â¸Ã�Â½Ã‘â€šÃ�ÂµÃ‘â‚¬ Ã�Â¾Ã‘ï¿½Ã‘â€šÃ�Â°Ã�Â½Ã�Â¾Ã�Â²Ã�Â»Ã�ÂµÃ�Â½. Ã�Â²Ã‘â€¹Ã�Â·Ã�Â¾Ã�Â² kill() !!"
	#define MSG_ERR_STOPPED						"Ã�Å¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã�Â¿Ã‘â‚¬Ã�Â¸Ã�Â½Ã‘â€šÃ�ÂµÃ‘â‚¬Ã�Â°, Ã�Â¾Ã‘ï¿½Ã‘â€šÃ�Â°Ã�Â½Ã�Â¾Ã�Â². Ã�Â£Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â°Ã�Â½Ã�Â¸Ã‘â€šÃ�Âµ Ã�Â½Ã�ÂµÃ�Â¸Ã‘ï¿½Ã�Â¿Ã‘â‚¬Ã�Â°Ã�Â²Ã�Â½Ã�Â¾Ã‘ï¿½Ã‘â€šÃ‘Å’ Ã�Â¸ Ã�Â¸Ã‘ï¿½Ã�Â¿Ã�Â¾Ã�Â»Ã‘Å’Ã�Â·Ã‘Æ’Ã�Â¹Ã‘â€šÃ�Âµ M999 Ã�Â´Ã�Â»Ã‘ï¿½ Ã�Â¿Ã�ÂµÃ‘â‚¬Ã�ÂµÃ�Â·Ã�Â°Ã�Â³Ã‘â‚¬Ã‘Æ’Ã�Â·Ã�ÂºÃ�Â¸!. (Ã�Â¢Ã�ÂµÃ�Â¼Ã�Â¿Ã�ÂµÃ‘â‚¬Ã�Â°Ã‘â€šÃ‘Æ’Ã‘â‚¬Ã�Â° Ã�Â½Ã�ÂµÃ�Â´Ã�Â¾Ã‘ï¿½Ã‘â€šÃ‘Æ’Ã�Â¿Ã�Â½Ã�Â°. Ã�Å¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�ÂµÃ‘â‚¬Ã‘Å’Ã‘â€šÃ�Âµ Ã�Â´Ã�Â°Ã‘â€šÃ‘â€¡Ã�Â¸Ã�ÂºÃ�Â¸)"
	#define MSG_RESEND							"Ã�Å¸Ã�ÂµÃ‘â‚¬Ã�ÂµÃ�Â¾Ã‘â€šÃ�Â¿Ã‘â‚¬Ã�Â°Ã�Â²Ã�ÂºÃ�Â°:"
	#define MSG_UNKNOWN_COMMAND					"Ã�ï¿½Ã�ÂµÃ�Â¸Ã�Â·Ã�Â²Ã�ÂµÃ‘ï¿½Ã‘â€šÃ�Â½Ã�Â°Ã‘ï¿½ Ã�ÂºÃ�Â¾Ã�Â¼Ã�Â°Ã�Â½Ã�Â´Ã�Â°:\""
	#define MSG_ACTIVE_EXTRUDER					"Ã�ï¿½Ã�ÂºÃ‘â€šÃ�Â¸Ã�Â²Ã�Â½Ã‘â€¹Ã�Â¹ Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â´Ã�ÂµÃ‘â‚¬: "
	#define MSG_INVALID_EXTRUDER				"Ã�Å¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â°"
	#define MSG_X_MIN							"x_min:"
	#define MSG_X_MAX							"x_max:"
	#define MSG_Y_MIN							"y_min:"
	#define MSG_Y_MAX							"y_max:"
	#define MSG_Z_MIN							"z_min:"
	#define MSG_Z_MAX							"z_max:"
	#define MSG_M119_REPORT						"Ã�Â¡Ã‘â€šÃ�Â°Ã‘â€šÃ‘Æ’Ã‘ï¿½ Ã�ÂºÃ�Â¾Ã�Â½Ã‘â€ Ã�ÂµÃ�Â²Ã�Â¸Ã�ÂºÃ�Â¾Ã�Â²"
	#define MSG_ENDSTOP_HIT						"Ã�Â¡Ã‘â‚¬Ã�Â°Ã�Â±Ã�Â°Ã‘â€šÃ‘â€¹Ã�Â²Ã�Â°Ã�Â½Ã�Â¸Ã�Âµ Ã�ÂºÃ�Â¾Ã�Â½Ã‘â€ Ã�ÂµÃ�Â²Ã�Â¸Ã�ÂºÃ�Â°"
	#define MSG_ENDSTOP_OPEN					"Ã�Å¡Ã�Â¾Ã�Â½Ã‘â€ Ã�ÂµÃ�Â²Ã�Â¸Ã�Âº Ã�Â¾Ã‘ï¿½Ã�Â²Ã�Â¾Ã�Â±Ã�Â¾Ã�Â¶Ã�Â´Ã�ÂµÃ�Â½"
	#define MSG_HOTEND_OFFSET					"Hotend offsets:"
	#define MSG_SD_CANT_OPEN_SUBDIR				"Ã�ï¿½Ã�Âµ Ã�Â¾Ã‘â€šÃ�ÂºÃ‘â‚¬Ã‘â€¹Ã‘â€šÃ‘Å’ Ã�Â¿Ã�Â°Ã�Â¿Ã�ÂºÃ‘Æ’"
	#define MSG_SD_INIT_FAIL					"Ã�Å¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã�Â¸Ã�Â½Ã�Â¸Ã‘â€ Ã�Â¸Ã�Â°Ã�Â»Ã�Â¸Ã�Â·Ã�Â°Ã‘â€ Ã�Â¸Ã�Â¸ SD"
	#define MSG_SD_VOL_INIT_FAIL				"Ã�Å¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã�Â¸Ã�Â½Ã�Â¸Ã‘â€ Ã�Â¸Ã�Â°Ã�Â»Ã�Â¸Ã�Â·Ã�Â°Ã‘â€ Ã�Â¸Ã�Â¸ Ã‘â‚¬Ã�Â°Ã�Â·Ã�Â´Ã�ÂµÃ�Â»Ã�Â°"
	#define MSG_SD_OPENROOT_FAIL				"Ã�ï¿½Ã�Âµ Ã�Â¿Ã‘â‚¬Ã�Â¾Ã‘â€¡Ã�ÂµÃ‘ï¿½Ã‘â€šÃ‘Å’ Ã‘ï¿½Ã�Â¾Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â¶Ã�Â¸Ã�Â¼Ã�Â¾Ã�Âµ Ã�ÂºÃ�Â¾Ã‘â‚¬Ã�Â½Ã‘ï¿½"
	#define MSG_SD_CARD_OK						"SD Ã�ÂºÃ�Â°Ã‘â‚¬Ã‘â€šÃ�Â° Ã�Â² Ã�Â¿Ã�Â¾Ã‘â‚¬Ã‘ï¿½Ã�Â´Ã�ÂºÃ�Âµ"
	#define MSG_SD_WORKDIR_FAIL					"Ã�Â½Ã�Âµ Ã�Â¾Ã‘â€šÃ�ÂºÃ‘â‚¬Ã‘â€¹Ã‘â€šÃ‘Å’ Ã‘â‚¬Ã�Â°Ã�Â±Ã�Â¾Ã‘â€¡Ã‘Æ’Ã‘Å½ Ã�Â¿Ã�Â°Ã�Â¿Ã�ÂºÃ‘Æ’"
	#define MSG_SD_OPEN_FILE_FAIL				"Ã�Å¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã‘â€¡Ã‘â€šÃ�ÂµÃ�Â½Ã�Â¸Ã‘ï¿½, Ã‘â€žÃ�Â°Ã�Â¹Ã�Â»: "
	#define MSG_SD_FILE_OPENED					"Ã�Â¤Ã�Â°Ã�Â¹Ã�Â» Ã�Â¾Ã‘â€šÃ�ÂºÃ‘â‚¬Ã‘â€¹Ã‘â€š:"
	#define MSG_SD_SIZE							" Ã�Â Ã�Â°Ã�Â·Ã�Â¼Ã�ÂµÃ‘â‚¬:"
	#define MSG_SD_FILE_SELECTED				"Ã�Â¤Ã�Â°Ã�Â¹Ã�Â» Ã�Â²Ã‘â€¹Ã�Â±Ã‘â‚¬Ã�Â°Ã�Â½"
	#define MSG_SD_WRITE_TO_FILE				"Ã�â€”Ã�Â°Ã�Â¿Ã�Â¸Ã‘ï¿½Ã‘Å’ Ã�Â² Ã‘â€žÃ�Â°Ã�Â¹Ã�Â»: "
	#define MSG_SD_PRINTING_BYTE				"SD Ã�Â¿Ã�ÂµÃ‘â€¡Ã�Â°Ã‘â€šÃ‘Å’ byte "
	#define MSG_SD_NOT_PRINTING					"Ã�Â½Ã�ÂµÃ‘â€š SD Ã�Â¿Ã�ÂµÃ‘â€¡Ã�Â°Ã‘â€šÃ�Â¸"
	#define MSG_SD_ERR_WRITE_TO_FILE			"Ã�Â¾Ã‘Ë†Ã�Â¸Ã�Â±Ã�ÂºÃ�Â° Ã�Â·Ã�Â°Ã�Â¿Ã�Â¸Ã‘ï¿½Ã�Â¸ Ã�Â² Ã‘â€žÃ�Â°Ã�Â¹Ã�Â»"
	#define MSG_SD_CANT_ENTER_SUBDIR			"Ã�ï¿½Ã�Âµ Ã�Â·Ã�Â°Ã�Â¹Ã‘â€šÃ�Â¸ Ã�Â² Ã�Â¿Ã�Â°Ã�Â¿Ã�ÂºÃ‘Æ’:"
	#define MSG_STEPPER_TOO_HIGH				"Ã�Â§Ã�Â°Ã‘ï¿½Ã‘â€šÃ�Â¾Ã‘â€šÃ�Â° Ã‘Ë†Ã�Â°Ã�Â³Ã�Â¾Ã�Â² Ã�Â¾Ã‘â€¡Ã�ÂµÃ�Â½Ã‘Å’ Ã�Â²Ã‘â€¹Ã‘ï¿½Ã�Â¾Ã�ÂºÃ�Â° : "
	#define MSG_ENDSTOPS_HIT					"Ã�ÂºÃ�Â¾Ã�Â½Ã‘â€ Ã�ÂµÃ�Â²Ã�Â¸Ã�Âº Ã‘ï¿½Ã‘â‚¬Ã�Â°Ã�Â±Ã�Â¾Ã‘â€šÃ�Â°Ã�Â»: "
	#define MSG_ERR_COLD_EXTRUDE_STOP			" Ã�Â·Ã�Â°Ã‘â€°Ã�Â¸Ã‘â€šÃ�Â° Ã‘â€¦Ã�Â¾Ã�Â»Ã�Â¾Ã�Â´Ã�Â½Ã�Â¾Ã�Â¹ Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â·Ã�Â¸Ã�Â¸"
	#define MSG_ERR_LONG_EXTRUDE_STOP			" Ã�Â·Ã�Â°Ã‘â€°Ã�Â¸Ã‘â€šÃ�Â° Ã�Â¿Ã‘â‚¬Ã�ÂµÃ�Â²Ã‘â€¹Ã‘Ë†Ã�ÂµÃ�Â½Ã�Â¸Ã‘ï¿½ Ã�Â´Ã�Â»Ã�Â¸Ã�Â½Ã�Â½Ã‘â€¹ Ã‘ï¿½Ã�ÂºÃ‘ï¿½Ã‘â€šÃ‘â‚¬Ã‘Æ’Ã�Â·Ã�Â¸Ã�Â¸"
	#define MSG_BABYSTEPPING_X "Babystepping X"
	#define MSG_BABYSTEPPING_Y "Babystepping Y"
	#define MSG_BABYSTEPPING_Z "Babystepping Z"
	#define MSG_SERIAL_ERROR_MENU_STRUCTURE "Error in menu structure"
...
// Serial Console Messages
	...
	#define MSG_BEGIN_FILE_LIST "ComeÃƒÂ§o da lista de arquivos"
	#define MSG_END_FILE_LIST "Fim da lista de arquivos"
	#define MSG_M104_INVALID_EXTRUDER "M104 Extrusor invÃƒÂ¡lido "
	#define MSG_M105_INVALID_EXTRUDER "M105 Extrusor invÃƒÂ¡lido "
	#define MSG_M200_INVALID_EXTRUDER "M200 Extrusor invÃƒÂ¡lido "
	#define MSG_M218_INVALID_EXTRUDER "M218 Extrusor invÃƒÂ¡lido "
	#define MSG_M221_INVALID_EXTRUDER "M221 Extrusor invÃƒÂ¡lido "
	#define MSG_ERR_NO_THERMISTORS "Nao ha termistor - no temp"
	#define MSG_M109_INVALID_EXTRUDER "M109 Extrusor invÃƒÂ¡lido "
	...
	#define MSG_ERR_STOPPED "Impressora parada por erros. Coserte o erro e use M999 para recomeÃƒÂ§ar!. (Temperatura reiniciada. Ajuste antes de recomeÃƒÂ§ar)"
	#define MSG_RESEND "Reenviar:"
...
// Serial Console Messages
	...
	#define MSG_ERR_NO_CHECKSUM "No se podiÃƒÂ³ trobar o Checksum con o numero de linea, Ultima Linea:"
	...
	#define MSG_HOTEND_OFFSET "Hotend offsets:"
	#define MSG_SD_CANT_OPEN_SUBDIR "No se podiÃƒÂ³ ubrir a subcarpeta."
